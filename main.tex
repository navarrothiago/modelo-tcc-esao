...
\usepackage{lipsum} % para gerar texto fictício
\usepackage{verbatim} %pacote para comentar várias linhas
\usepackage{tocloft} %personalizar a formatação e o layout das listas de conteúdo, figuras e tabelas,
\usepackage[acronym,nonumberlist,nogroupskip]{glossaries} %personalizar a lista de siglas
\makenoidxglossaries
...
\newglossarystyle{custom}{%
    ...
    {\begin{longtable}{p{2,5cm}l{\glsdescwidth}}}
    {\end{longtable}}
    \renewcommand*{\glossaryheader}{}
    \renewcommand*{\glsgroupheading}[1]{}
    \renewcommand*{\glossaryentryfield}[5]{
        \glstarget{##1}{\textnormal{##2}} & \emph{##3} \tabularnewline
    }
}

%Lista de Abreviaturas
%seguir o modelo de abreviatura 
%\newacronym{atalho}{Sigla}{descrição} 
...
\begin{titlepage}
   ...
   \vspace*{3cm} % Espaçamento de 3cm do topo da página
    ...
    \vspace*{2\baselineskip} % Um espaço duplo
    ...
    \vspace*{2\baselineskip} % um espaços duplos

    \begin{flushleft}
        Aprovado em \makebox[1cm]{\hrulefill} /  \makebox[1cm]{\hrulefill} /  2023. % Data de aprovação
    \end{flushleft}
    ...
    \begin{center}
        ...
        Coordenador do CAM % Credenciais
...
\renewcommand{\cftfigpresnum}{Figura } % Prefixo antes do número da figura
\renewcommand{\cftfigaftersnum}{ --} % Sufixo após o número da figura
\setlength{\cftfignumwidth}{5em} % Espaçamento para números das figuras (ajuste conforme necessário)
...
\end{center}
\vspace*{3\baselineskip}
%\printnoidxglossary[type=acronym, title={}, toctitle={Lista de Abreviaturas}]
