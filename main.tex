...
\begin{titlepage}
    ...
    \textbf{Cap QEM THIAGO ARRUDA NAVARRO DO AMARAL} % Nome do autor

    \vspace{7\baselineskip} % Sete espaços duplos

    \textbf{TÍTULO DO TRABALHO} % Título do trabalho
...
\begin{titlepage}
    ...
    \begin{minipage}{0.5\textwidth}
        ...
        Orientador: Maj QEM Fulano de \textbf{Tal} % Nome do orientador
    \end{minipage}
    \end{flushright}
...
\begin{titlepage}
    ...
    \textbf{THIAGO ARRUDA NAVARRO DO AMARAL} % Nome do autor
